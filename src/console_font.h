...
// Bold console face: 5x7 glyphs expanded into a 12x24 cell.
// The design favors readability on the 2.8" LCD: thick strokes, open counters,
// and a slashed zero.
inline constexpr uint8_t consoleFont5x7[96][7] = {
    ...
    {0x0E,0x11,0x19,0x15,0x13,0x11,0x0E}, // 0 slashed
    ...
    {0x03,0x08,0x08,0x10,0x08,0x08,0x03}, // }
